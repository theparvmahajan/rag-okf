---
id: okf-structure/tutorials/cluster-management/provision-swap-memory.md#install-a-swap-enabled-cluster-with-kubeadm
kind: section
...
heading: Install a swap-enabled cluster with kubeadm
parent: okf-structure/tutorials/cluster-management/provision-swap-memory
children: []
prev_sibling: okf-structure/tutorials/cluster-management/provision-swap-memory.md#prerequisites
next_sibling: null
word_count: 424
---
