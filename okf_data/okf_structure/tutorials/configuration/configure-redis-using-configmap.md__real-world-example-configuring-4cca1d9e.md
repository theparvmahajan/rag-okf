---
id: okf-structure/tutorials/configuration/configure-redis-using-configmap.md#real-world-example-configuring-redis-using-a-configmap
kind: section
...
heading: 'Real World Example: Configuring Redis using a ConfigMap'
parent: okf-structure/tutorials/configuration/configure-redis-using-configmap
children: []
prev_sibling: okf-structure/tutorials/configuration/configure-redis-using-configmap.md#prerequisites
next_sibling: okf-structure/tutorials/configuration/configure-redis-using-configmap.md#whatsnext
word_count: 521
---
