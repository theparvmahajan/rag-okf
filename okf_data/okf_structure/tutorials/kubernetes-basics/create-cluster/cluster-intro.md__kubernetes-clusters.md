---
id: okf-structure/tutorials/kubernetes-basics/create-cluster/cluster-intro.md#kubernetes-clusters
kind: section
...
parent: okf-structure/tutorials/kubernetes-basics/create-cluster/cluster-intro
children: []
prev_sibling: okf-structure/tutorials/kubernetes-basics/create-cluster/cluster-intro.md#prerequisites
next_sibling: okf-structure/tutorials/kubernetes-basics/create-cluster/cluster-intro.md#create-a-minikube-cluster
word_count: 419
---
