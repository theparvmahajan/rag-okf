---
id: okf-structure/tutorials/services/pods-and-endpoint-termination-flow.md#example-flow-with-endpoint-termination
kind: section
...
heading: Example flow with endpoint termination
parent: okf-structure/tutorials/services/pods-and-endpoint-termination-flow
children: []
prev_sibling: okf-structure/tutorials/services/pods-and-endpoint-termination-flow.md#termination-process-for-pods-and-their-endpoints
next_sibling: okf-structure/tutorials/services/pods-and-endpoint-termination-flow.md#whatsnext
word_count: 406
---
