---
id: okf-structure/tasks/administer-cluster/migrating-from-dockershim/troubleshooting-cni-plugin-related-errors.md#about-the-incompatible-cni-versions-and-failed-to-destroy-network-for-sandbox-errors
kind: section
title: About the "Incompatible CNI versions" and "Failed to destroy network for sandbox"
  errors
...
heading: About the "Incompatible CNI versions" and "Failed to destroy network for
  sandbox" errors
parent: okf-structure/tasks/administer-cluster/migrating-from-dockershim/troubleshooting-cni-plugin-related-errors
children: []
prev_sibling: okf-structure/tasks/administer-cluster/migrating-from-dockershim/troubleshooting-cni-plugin-related-errors.md#introduction
next_sibling: okf-structure/tasks/administer-cluster/migrating-from-dockershim/troubleshooting-cni-plugin-related-errors.md#an-example-containerd-configuration-file
word_count: 445
---
