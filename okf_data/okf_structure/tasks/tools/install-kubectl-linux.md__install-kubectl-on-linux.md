---
id: okf-structure/tasks/tools/install-kubectl-linux.md#install-kubectl-on-linux
kind: section
...
children: []
prev_sibling: okf-structure/tasks/tools/install-kubectl-linux.md#prerequisites
next_sibling: okf-structure/tasks/tools/install-kubectl-linux.md#verify-kubectl-configuration
word_count: 967
---
