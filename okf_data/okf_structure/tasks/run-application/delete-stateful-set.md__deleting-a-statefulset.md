---
id: okf-structure/tasks/run-application/delete-stateful-set.md#deleting-a-statefulset
kind: section
...
heading: Deleting a StatefulSet
parent: okf-structure/tasks/run-application/delete-stateful-set
children: []
prev_sibling: okf-structure/tasks/run-application/delete-stateful-set.md#prerequisites
next_sibling: okf-structure/tasks/run-application/delete-stateful-set.md#whatsnext
word_count: 356
---
