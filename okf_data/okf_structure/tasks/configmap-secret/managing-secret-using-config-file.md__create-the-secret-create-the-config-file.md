---
id: okf-structure/tasks/configmap-secret/managing-secret-using-config-file.md#create-the-secret-create-the-config-file
kind: section
...
heading: Create the Secret {#create-the-config-file}
parent: okf-structure/tasks/configmap-secret/managing-secret-using-config-file
children: []
prev_sibling: okf-structure/tasks/configmap-secret/managing-secret-using-config-file.md#prerequisites
next_sibling: okf-structure/tasks/configmap-secret/managing-secret-using-config-file.md#edit-a-secret-edit-secret
word_count: 565
---
...
1. Create the Secret using `kubectl apply`:
