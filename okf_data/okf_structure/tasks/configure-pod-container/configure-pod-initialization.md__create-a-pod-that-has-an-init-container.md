---
id: okf-structure/tasks/configure-pod-container/configure-pod-initialization.md#create-a-pod-that-has-an-init-container
kind: section
...
heading: Create a Pod that has an Init Container
parent: okf-structure/tasks/configure-pod-container/configure-pod-initialization
children: []
prev_sibling: okf-structure/tasks/configure-pod-container/configure-pod-initialization.md#prerequisites
next_sibling: okf-structure/tasks/configure-pod-container/configure-pod-initialization.md#whatsnext
word_count: 230
---
