---
id: okf-structure/tasks/inject-data-application/define-interdependent-environment-variables.md#define-an-environment-dependent-variable-for-a-container
kind: section
...
heading: Define an environment dependent variable for a container
parent: okf-structure/tasks/inject-data-application/define-interdependent-environment-variables
children: []
prev_sibling: okf-structure/tasks/inject-data-application/define-interdependent-environment-variables.md#prerequisites
next_sibling: okf-structure/tasks/inject-data-application/define-interdependent-environment-variables.md#whatsnext
word_count: 288
---
