---
id: okf-structure/tasks/manage-daemon/pods-some-nodes.md#running-pods-on-only-some-nodes
kind: section
...
heading: Running Pods on only some Nodes
parent: okf-structure/tasks/manage-daemon/pods-some-nodes
children: []
prev_sibling: okf-structure/tasks/manage-daemon/pods-some-nodes.md#prerequisites
next_sibling: null
word_count: 213
---
