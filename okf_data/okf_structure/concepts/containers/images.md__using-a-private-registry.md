---
id: okf-structure/concepts/containers/images.md#using-a-private-registry
kind: section
title: Using a private registry
source: concepts/containers/images.md
url: https://kubernetes.io/docs/concepts/containers/images/
heading: Using a private registry
parent: okf-structure/concepts/containers/images
children: []
prev_sibling: okf-structure/concepts/containers/images.md#multi-architecture-images-with-image-indexes
next_sibling: okf-structure/concepts/containers/images.md#legacy-built-in-kubelet-credential-provider
word_count: 1768
---
...
- Using a _kubelet credential provider_ plugin to dynamically fetch credentials for private registries
