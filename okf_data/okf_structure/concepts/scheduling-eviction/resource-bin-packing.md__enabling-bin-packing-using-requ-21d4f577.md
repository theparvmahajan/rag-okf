---
id: okf-structure/concepts/scheduling-eviction/resource-bin-packing.md#enabling-bin-packing-using-requestedtocapacityratio
kind: section
...
heading: Enabling bin packing using RequestedToCapacityRatio
parent: okf-structure/concepts/scheduling-eviction/resource-bin-packing
children: []
prev_sibling: okf-structure/concepts/scheduling-eviction/resource-bin-packing.md#enabling-bin-packing-using-mostallocated-strategy
next_sibling: okf-structure/concepts/scheduling-eviction/resource-bin-packing.md#whatsnext
word_count: 778
---
