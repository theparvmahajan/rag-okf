---
id: okf-structure/setup/production-environment/tools/kubeadm/setup-ha-etcd-with-kubeadm.md#setting-up-the-cluster
kind: section
...
heading: Setting up the cluster
parent: okf-structure/setup/production-environment/tools/kubeadm/setup-ha-etcd-with-kubeadm
children: []
prev_sibling: okf-structure/setup/production-environment/tools/kubeadm/setup-ha-etcd-with-kubeadm.md#prerequisites
next_sibling: okf-structure/setup/production-environment/tools/kubeadm/setup-ha-etcd-with-kubeadm.md#whatsnext
word_count: 935
---
